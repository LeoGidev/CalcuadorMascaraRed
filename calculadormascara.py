...
class calculadoraRED:
    ...
    def create_labels_and_entries(self):
        ...
        Label(self.lateral, text='Indque corriente consumida en baterías', background='#414141', foreground='white').grid(row=0, column=0, columnspan=2, sticky='ew', padx=0, pady=10)
